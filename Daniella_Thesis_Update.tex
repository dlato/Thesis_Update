...
I
 ...
 did not get a chance to look into the output from the two inversion visualization figures (with and without ATCC reverse complemented) (Figures \ref{fig:inversion_norevcomp} and \ref{fig:inversion_revcomp}).
