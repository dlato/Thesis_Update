...
\textbf{The substitutions paper draft is almost complete so if you have any additional tests/analysis for this paper that you think I should do please tell me now so it is less of a shock.}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=\textwidth]{C:/Users/synch/Documents/PhD/Substitutions_paper/GBE_paper_format/figs/sinoC_dN_dS_omega_dist_NO_OUTLIERS_23Apr20.pdf}
...
\begin{table}[h]
	...
	\resizebox{0.5\textwidth}{!}{%
		\begin{tabular}{lccc}
			...
			\midrule
			\smel Chromosome & NS & -2.29\e{-9}* & NS \\
			\bottomrule
		\end{tabular}
