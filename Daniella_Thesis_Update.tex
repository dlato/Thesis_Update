...
$\checkmark$	Aug 13: First draft of presentation due
	...
	Aug 18: Second draft of presentation due
...
\begin{itemize}
	\item Comps Report submitted
	\item Comps papers for Topics all read and made notes
	\item Comps presentation first draft complete
	\item Combined all non-R scripts into one command so Clustering testing can be run faster
\end{itemize}
...
\section*{This Week}
I will be practising my presentation and making any adjustments that are necessary.
I will also be reviewing my comp topics and notes made from the papers.
...
I have all the steps for the clustering analysis separate so it is taking longer to run because I have to run each step. I want to work on condensing this so there is less ``checking in'' that I have to do.

\section*{Next Week}
My exam is on Aug 21 so I will be spending the beginning of the week preparing for that and the rest of the week organizing deadlines for other projects.
