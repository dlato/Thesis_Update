...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lccc}
			...
			\midrule
			Grainger 2006 \cite{Grai:06} & NS & NS & 37\\
			Ueda 2013 \cite{Ueda:13} &  NS & NS & 165\\
			Higashi 2016 \cite{Higa:16} & &&\\
			\hspace*{10mm} criteria A & 0.103*& 0.113*** & 206\\
			\hspace*{10mm} criteria B & 0.102* & 0.104*** & 189\\
			\hspace*{10mm} criteria C & 0.102* & 0.104*** & 189\\
			\hspace*{10mm} criteria D & 0.102* & 0.104*** & 189\\
			\hspace*{10mm} criteria E & 0.105* & 0.104***& 187\\
			\hspace*{10mm} criteria F & 0.105* & 0.104*** &187\\
			Lang 2007 \cite{Lang:07} & 0.101* & -0.056* & 80\\ %composite data
			Oshima 2006 \cite{Oshi:06} & NS & NS & 277\\
			\bottomrule
		\end{tabular}
