...
\ch  define a theme for the substitutions graphs (and selection graphs)

\ch Added selection values summary plot (violin plots) to supplement with caption to explain all the intricacies of the plot

\ch attempted to use the median instead of the mean for the \smel chromosome plot (did not make a difference)

\ch check into high \ds values for \strep

\ch why does it look like some bac have missing data (i.e. \bass, \smel chrom ...etc.)
...
I tried to use the median of each 100Kbp region as points for the trend lines in the selection distribution graph for \smel chromosome, but it did not make a difference in making the graph ``look'' nicer or more accurate. So I will be sticking with what I did previously.

I looked into the two sections of the \strep selection distribution graph that had very high \ds values and they are real! These are genes that just have a lot of synonymous changes and only one non-synonymous change!

For the portions of the selection distribution graphs that look like there are large chunks of data missing, it looks like this is actually missing data.
This is what I spent most of my week trying to figure out (past me was not as good at keeping notes as current me).
This ``missing data'' was discarded at the stage where any block with a tree that was significantly different from the overall tree (via SH-Test in RAxML) was chucked.
I had to re-do the calculations for which block trees did not match the overall tree.
Below is Table \ref{fig:treetopresults}, showing the results from the SH-test.
For \strep, there are only 3 taxa and you therefore can not perform an SH-test (it needs minimum of 4).
I am not sure what to do because in the case of \ecol and the chrom of \smel, about 25\% of the whole alignment is thrown out. I am not sure if we need to do this step since we are now being very conservative with which alignments we are keeping later on (trimal + my code). Since the test can not be done on \strep, I am  also not sure if we should use it for the other replicons. \textbf{Thoughts?}
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{C:/Users/synch/Documents/PhD/Thesis_Update/ecoli_dN_dS_omega_dist_18Mar20.pdf}
		\caption{Selection data \textbf{accounting} for bidirectional replication}
		\label{fig:e1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{ecoli_missing_data_check_dot_plot_18Mar20}
		\caption{Selection data with NO bidirectional replication accounted for. To show where missing data is}
		\label{fig:e2}
	\end{subfigure}
	\label{fig:ecoli}
\end{figure}
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{C:/Users/synch/Documents/PhD/Thesis_Update/bass_dN_dS_omega_dist_18Mar20.pdf}
		\caption{Selection data \textbf{accounting} for bidirectional replication}
		\label{fig:b1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{bass_missing_data_check_dot_plot_18Mar20}
		\caption{Selection data with NO bidirectional replication accounted for. To show where missing data is}
		\label{fig:b2}
	\end{subfigure}
	\label{fig:bass}
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{C:/Users/synch/Documents/PhD/Thesis_Update/strep_dN_dS_omega_dist_18Mar20.pdf}
		\caption{Selection data \textbf{accounting} for bidirectional replication}
		\label{fig:s1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{strep_missing_data_check_dot_plot_18Mar20}
		\caption{Selection data with NO bidirectional replication accounted for. To show where missing data is}
		\label{fig:s2}
	\end{subfigure}
	\label{fig:strep}
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{C:/Users/synch/Documents/PhD/Thesis_Update/sinoC_dN_dS_omega_dist_18Mar20.pdf}
		\caption{Selection data \textbf{accounting} for bidirectional replication}
		\label{fig:sC1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{sinoC_missing_data_check_dot_plot_18Mar20}
		\caption{Selection data with NO bidirectional replication accounted for. To show where missing data is}
		\label{fig:sC2}
	\end{subfigure}
	\label{fig:sinoC}
...
\begin{subfigure}{.5\textwidth}
	\centering
	\includegraphics[width=0.9\linewidth]{C:/Users/synch/Documents/PhD/Thesis_Update/pSymA_dN_dS_omega_dist_18Mar20.pdf}
	\caption{Selection data \textbf{accounting} for bidirectional replication}
	\label{fig:sA1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
	\centering
	\includegraphics[width=0.9\linewidth]{pSymA_missing_data_check_dot_plot_18Mar20}
	\caption{Selection data with NO bidirectional replication accounted for. To show where missing data is}
	\label{fig:sA2}
\end{subfigure}
\label{fig:pSymA}
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{C:/Users/synch/Documents/PhD/Thesis_Update/pSymB_dN_dS_omega_dist_18Mar20.pdf}
		\caption{Selection data \textbf{accounting} for bidirectional replication}
		\label{fig:sB1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{pSymB_missing_data_check_dot_plot_18Mar20}
		\caption{Selection data with NO bidirectional replication accounted for. To show where missing data is}
		\label{fig:sB2}
	\end{subfigure}
	\label{fig:pSymB}
