...
\ch looked into phylogenetic papers on \strep that Marie sent me

\ch re-run \strep analysis (was using the wrong tree last time)

\ch tweak the selection distribution figures (fix labelling on axis)

\ch gene expression paper latex template working

\ch gene expression paper edits and minor formatting fixes

\textbf{Gene Expression Paper}

I sent you the latest draft of the paper which is formatted properly in the latex template that the journal provides.
I spent most of the week getting this to work, editing and tweaking other minor formatting issues.
...
I realized that I was using the wrong phylogenetic tree for the \strep analysis, so I need to re-do this (and the selection analysis) over again.
I started this late last week and this should be done by the end of this week at the latest.

I also slightly changed the selection genomic distribution figures (edited axis names). These are found in the attached supplement file. 
...
\begin{enumerate}
	...
	\item gene expression paper data + code up on github
	\item finish all final formatting for gene expression paper so all I have to do is click submit!
\end{enumerate}


\section*{Next Week}
\begin{enumerate}
	\item analize selection results
	\item analize substitutions results
...
\begin{table}[h]
	...
	\caption{\label{tab:lr_exp_10Kbp} Linear regression analysis of the median counts per million expression data for 10Kbp segments of the genome of the respective bacteria replicons. Linear regression was calculated after the origin of replication was moved to the beginning of the genome and all subsequent positions were scaled around the origin accounting for bidirectional replication. All results are marked with significance codes as followed: $<$ 0.001 = `***', 0.001 $<$ 0.01 = `**', 0.01 $<$ 0.05 = `*', $>$ 0.05 = `NS'.}
\end{table}

%\includegraphics[width=\textwidth]{all_gene_exp_coef_plot.pdf}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lc}
			...
			\midrule
			\ecol Chromosome & -2.98\e{-8}*** \\
			\bass Chromosome & -8.06\e{-8}***\\
			\strep Chromosome & 1.10\e{-7}***\\
			\smel Chromosome & -4.32\e{-7}***\\
			\smel pSymA & -5.18\e{-7}*** \\
			\smel pSymB & 1.76\e{-7}***\\
			\bottomrule
		\end{tabular}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc|cc}
			...
			\midrule
			\ecol Chromosome & -1.17\e{-5}** & NS & 5.91\e{-3} & 6.92\e{-3} \\
			\bass Chromosome & NS & -8.96\e{-5}*** & 1.97\e{-3} & 9.04\e{-3} \\
			\strep Chromosome & 7.45\e{-5}*** & -1.32\e{-4}*** & 6.48\e{-4} & 6.73\e{-3} \\
			\smel Chromosome & 8.26\e{-5}* & NS & 9.79\e{-5}  & 5.07\e{-5}\\
			\smel pSymA & NS  & NS & 9.80\e{-4} & 3.24\e{-3}\\
			\smel pSymB & -1.42\e{-5}* & -6.32\e{-5}*** & 1.97\e{-3} &  1.24\e{-3} \\
			\bottomrule
		\end{tabular}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc}
			...
			\midrule
			\ecol Chromosome & -2.25\e{-10}**  & -1.89\e{-4}***\\
			\bass Chromosome & -8.35\e{-10}** &  -1.91\e{-4}**\\
			\strep Chromosome & 5.45\e{-11}***& NS \\
			\smel Chromosome & -1.11\e{-10}*** & -1.28\e{-5}***\\
			\smel pSymA & NS  & NS \\
			\smel pSymB & NS & NS \\
			\bottomrule
		\end{tabular}
...
\begin{table}[h]
	...
	\begin{tabular}{lc}
			...
			\midrule
			\ecol Chromosome & -2.51\e{-2}*** \\
			\bass Chromosome & -2.00\e{-2}**\\
			\strep Chromosome & -1.74\e{-3}***\\
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lrrrrrr}
			...
			\midrule
			\ecol Chromosome & 0.2843 & 0.0145 & 0.0574 & 0.3072 & 0.0181 & 0.0663 \\
			\bass Chromosome & 0.6241 & 0.0353 & 0.0922 & 0.5708 & 0.0335 & 0.0841\\
			\strep Chromosome &  0.0694 & 0.0062 & 0.6071 & 0.0615 & 0.0042  & 0.5877  \\
			\smel Chromosome &  0.0162  & 0.0011 & 0.1465 & 0.0171 & 0.0012 & 0.1158 \\
			\smel pSymA & 0.0865 & 0.0122 & 0.2250 & 0.0839 & 0.0106 & 0.2125 \\
