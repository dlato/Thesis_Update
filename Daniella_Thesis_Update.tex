...
$\checkmark$	July 20: Have date booked for Comps
	...
	July 20: Have all resources to read for comps topics
	
	July 21-Aug 10: Read all above resources
	
	July 21-Aug 4: Write committee report (first draft)
	
	July 30 - Aug 13: Work on first draft of presentation
	
	Aug 4: First draft of commps report due
	
	Aug 10: Finish reading all resources for comps
	
	Aug 13: Submit Comps Report to Committee
	
	Aug 13: First draft of presentation due
...
Last week I was away at the conference. I wrote down a few notes about things to look up related to my project. The most notable is that apparently in mitochondria they have found the number of substitutions to increase near the origin. This would be really cool to look at!

\section*{This Week}
I solidified the clustering algorithms and steps before I left for Chicago so I will be running those a million and one times to see how (if) clustering impacts the substitution trends.

I also want to look up the above stuff that I wrote down at the conference.

I want to come up with a solid plan/timeline for my comps preparation so I will be doing that this week as well.

\section*{Next Week}
I will be continuing to work on the clustering stuff and looking at what gene expression data is available for the inversion and gene expression stuff.
