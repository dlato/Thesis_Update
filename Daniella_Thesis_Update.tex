...
%
\begin{itemize}
	\item check why genes are ``missing'' from mapping file (BW and K12)
	...
	\item look at duplicated rows for all genes/species mapping
	\item think about if we can use/compare block with less than all taxa for inversions analysis
