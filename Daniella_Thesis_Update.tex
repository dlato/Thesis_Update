...
\ch Downloaded proteomes for Inversions blast analysis

\ch detailed list of things for Queenie to do

\ch (virtual) meeting with Queenie to update her on next steps for the inversions project

\ch organize inversion paper notes into broad categories for intro

\ch outline for inversions paper

\ch wrote first rough draft of intro for inversions paper

\ch Brian's edits to substitution paper

Most of last week I spent getting Queenie caught up on the inversions project.
She is still excited to work on it and we will be meeting twice a week (virtually) to discuss her progress.
So far she is working on combining the dataframes with information on gene expression and gene position.

I finished the edits you asked me to make on the substitutions paper and have attached the latest draft to this email.
\textbf{If you could look over this again that would be great!}
...
\begin{itemize}
	...
	\item look over requirements for GBE submission and create a folder/complete draft of the paper to be submitted
	\item write cover letter for substitutions paper submission
	\item work on code to grab gene info for inversions project
\end{itemize}
...
\begin{itemize}
	...
	\item start writing methods for the inversions and gene expression paper
