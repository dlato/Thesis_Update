...
$\checkmark$	Sep 18: Present in Lab Meeting
	...
	Sep 30: Have all clustering testing complete for all bacteria

	Sep 30: Compile notes from comps papers into one document
		
	Oct 5: Gene expression data for the inversions project
...
\section*{Last Week}
I had my lab meeting presentation. If are any comments you have about that please let me know.
I was running the position clustering and it will for sure be done at the end of this week. There is only \smel and \strep left.

I spent most of last week working on my code to extract the coding and non-coding segments of the genomes. I am nearly done this.
Just double checking that there are no bugs or things that I have missed.

I also finished going through the PARSNP file with a list of \ecol that you had aligned, to try and find gene expression data.
There is a VERY limited number of raw control gene expression data sets for different strains of \ecol (8 data sets in total).
There might be more data sets for the more popular strains like k-12. 
...
\section*{This Week}
I would like to continue to work on the clustering testing, and will have it done by the end of the week.

I would also like to finish the code for getting the coding and non-coding portions of the genome (which shouldn't be too difficult) and begin re-doing the substitution analysis on both sections of the genome.
...
\section*{Next Week}
I would like to keep running the coding and non-coding analysis.

I would like to look into the inversions and gene expression stuff more in-depth and come up with some possible inversions to test the gene expression in these regions.

I would like to add the info from my comps paper notes to re-write the intro for the substitutions paper.
