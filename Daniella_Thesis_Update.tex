...
\ch Finish re-doing the coding/non-coding analysis (after fixing the code)


Finished re-doing the coding/non-coding analysis (again) with the proper code. The results are summarized in the table below.
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc}
			...
			\smel Chromosome & NS & \cc -1.546\e{-6}***\\
