...
\begin{table}[h]
	...
	\caption{\label{tab:lr_exp_10Kbp} Linear regression analysis of the median counts per million expression data for 10Kbp segments of the genome of the respective bacteria replicons. Linear regression was calculated after the origin of replication was moved to the beginning of the genome and all subsequent positions were scaled around the origin accounting for bidirectionality of replication. All results are marked with significance codes as followed: $<$ 0.001 = `***', 0.001 $<$ 0.01 = `**', 0.01 $<$ 0.05 = `*', $>$ 0.05 = `NS'.}
\end{table}

\includegraphics[width=\textwidth]{all_gene_exp_coef_plot.pdf}


\includegraphics[width=\textwidth]{ecoli_weighted_subs_bidirectionality_colour_2Nov19.pdf}
...
\includegraphics[width=\textwidth]{pSymA_weighted_subs_bidirectionality_colour_2Nov19.pdf}
\includegraphics[width=\textwidth]{pSymB_weighted_subs_bidirectionality_colour_2Nov19.pdf}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lc}
			...
			\midrule
			\ecol Chromosome & -2.99\e{-8}*** \\
			\bass Chromosome & -8.05\e{-8}***\\
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc|cc}
			...
			\midrule
			\ecol Chromosome & -1.21\e{-5}** & -2.68\e{-5}* & 5.95\e{-3} & 7.03\e{-3} \\
			\bass Chromosome & NS & -4.25\e{-5}** & 1.97\e{-3} & 8.75\e{-3} \\
			\strep Chromosome & 9.05\e{-5}*** & -1.36\e{-4}*** & 6.65\e{-4} & 6.05\e{-3} \\
			\smel Chromosome & NS & NS & 9.85\e{-5}  & 5.18\e{-5}\\
			\smel pSymA & NS  & NS & 9.61\e{-4} & 3.53\e{-3}\\
			\smel pSymB & -2.29\e{-5}*** & -5.60\e{-5}*** & 1.98\e{-3} &  1.22\e{-3} \\
			\bottomrule
		\end{tabular}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc}
			...
			\midrule
			\ecol Chromosome & -3.31\e{-10}**  & -1.93\e{-4}***\\
			\bass Chromosome & 1.01\e{-9}*** &  -2.08\e{-4}***\\
			\strep Chromosome & 2.64\e{-10}***& NS \\
			\smel Chromosome & -1.49\e{-10}*** & -1.82\e{-5}***\\
			\smel pSymA & NS  & -1.17\e{-4}* \\
			\smel pSymB & NS & NS \\
			\bottomrule
		\end{tabular}
...
\begin{table}[h]
	...
	\begin{tabular}{lc}
			...
			\midrule
			\ecol Chromosome & -2.50\e{-2}*** \\
			\bass Chromosome & -1.99\e{-2}**\\
			\strep Chromosome & -1.74\e{-3}***\\
			\smel Chromosome & -1.90\e{-2}***\\
			\smel pSymA & -2.44\e{-2}*  \\
			\smel pSymB & NS \\
			\bottomrule
		\end{tabular}
