...
$X$	May 25: Think about/compile list of inversions in \ecol for new paper
...
Last week I finished reading the list of papers that I had. I still think I could use more about gene expression so if you have any suggestions I would appreciate it.
I also began to test out the ancestral reconstruction script you wrote for the genomic positions.

\section*{This Week}
I would like to continue to work on testing the new ancestral reconstruction script this week.
I also need to start picking a date for Comps and a Committee meeting.
I would also like to compile a list of inversions for the gene expression/inversion paper.
