...
\ch general formatting

\ch declaration of authorship

\ch final edit for intro and conclusion

\ch insert substitutions chapter
...
I spent most of the break working on your edits for the final chapter of my dissertation.
I also fixed formatting and citation errors.
The substitutions chapter and supplement has been added to the dissertation.1
%\textbf{Inversions + Gene Expression:}
...
\begin{itemize}
\item fix any supplementary things that are missing in inversions paper	
	
\item Brian's edits for inversions paper

\item send Brian new draft of inversions paper (with supplement)
...
\section*{Next Week}
\begin{itemize}
	\item Send dissertation to committee (Jan 18th)
	\item maybe do inversions in 10kb blocks? (and other sliding windows?)
	\item dist from ori on DESeq results?

% week of dec 28
%\item double check authors for each chapter
%\item check missing acronyms
...
\begin{figure}
	\includegraphics[width=\textwidth]{C:/Users/synch/Documents/PhD/inversion_and_gene_exp_work/Stats/hns_hist.pdf}
