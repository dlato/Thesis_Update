...
\ch finish re-running selection and substitutions analysis! 

\ch look into genes that have $\omega$ $>$ 1
...
%
Working on writing a first draft of my thesis intro and trying to get the McMaster \LaTeX template working.


\section*{Next Week}
I will be back and continuing to work on the substitutions/selection analysis working out any kinks.
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc|cc}
			...
			\midrule
			\ecol Chromosome & NS & NS & 5.62\e{-3} & 6.79\e{-3} \\
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc}
			...
			\midrule
			\ecol Chromosome & -2.30\e{-10}***  & -1.74\e{-4}***\\
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lrrrrrr}
			...
			\smel Chromosome &  0.0127  & 0.0009 & 0.0569 & 0.0144 & 0.0010 & 0.0717 \\
