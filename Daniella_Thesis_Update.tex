...
Last week I was mostly busy with my competition but I got a few things done. 
Before the break we determined that if you have one gene overlapping with 2 genes from another taxa there could be a situation where the nucleotides in one column of an alignment are not the same class.
So they may not be the 1st codon position, or 2nd...etc.
Since then, I have been working on determining how often this happens in the alignment of a sample block from \ecoli.
I have gotten this information but, it becomes more complicated when there are genes within genes in some of the taxa. This means that some genes overlap WITHIN a taxa and so one particular site in the alignment may be classified as more than one thing (1st, 2nd, 3rd, or non coding).
I am still working on how to classify/deal with this issue to get accurate information about each column in the alignment.

Once that is figured out then I can re-do the coding/non-coding part of the analysis.

I also sent you a draft of my substitutions paper before reading week which I would really appreciate your feedback on.

I also read and made notes on quite a few papers last week, gathering more information about gene expression and inversions.

%These are below. The graphs kind of look wrong to me because they look like there is more coding subs than non-coding, when in actuality there are not.
%But I think this may be the way that R does stacked bar graphs so I need to look into this further.
%I think these graphs give a better picture of what is going on with the substitution data and how it relates to coding and non-coding sites.
%I am also not quite sure what to do about the outliers in these graphs..because the coding and non-coding subsets have different outliers.
...
I would like to have the data on how many columns of the alignments are actually comparing the same nucleotide classification (1st, 2nd, 3rd, non-coding) and then make a decision on how to deal with the results from this.
...
%			\smel Chromosome & 3.97\e{-5} & 4.25\e{-5} & 3.5\e{-1}\\
