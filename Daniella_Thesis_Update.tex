...
\ch look into \strep \dn > \ds issue

\ch look into why \pb is missing so much data in the \dn/\ds distribution graphs

\ch send you two paper drafts, one for the substitutions paper and one for the gene expression paper
...
I also continued to look into why \pb is missing so much data, and why \strep had \dn > \ds for the whole genome. I realized that my definitions for the start and endings of genes was slightly off, and there was an issue with the genome positions that my program was spitting out. So I have fixed these issues and I am re-running all of this now to see if this makes a difference for the \pb and \strep selection issues.
