...
\ch looked up requirements for gene expression paper submission (they have a latex template that looks like it will actually work!)

\ch interactive gene expression graphs for all replicons, up on github 

\ch re-run selection analysis (results below)

\ch re-run substitutions analysis (results below + in attached supplement)

\ch remove outliers in any 10kb linear regressions
...
I have not looked into these results in depth yet but so far they look good!
...
\begin{enumerate}
	...
	\item get gene expression paper into latex template from Journal
\end{enumerate}
...
\begin{enumerate}
	...
	\item final edits for gene expression paper?
