...
$\checkmark$	April 27: Manuscript for Substitution and Gene expression paper finished
	...
	Find gene expression papers for bacteria and specific bacteria
	
	Read above papers and make notes
	
	Create outline for gene expression paper
	
	Write Write Write gene expression paper
	
	May 11: Think about/compile list of inversions in \ecol
	
	May 18: Gather gene expression data for the above mentioned \ecol strains
	
	June 1: Have gene expression/inversion data combined and in graphical format/regression lines calculated
	
	June 8: re-do gene exp/sub graphs with patchwork R package so they line up exactly
	
	June 30: Have data for other molecular trends (GC content, number of genes, essential gene lists..etc.) combined with graphs (or in supplement) for sub analysis
	
	June 30: Have date booked for Comps
	
	July 1 - August 31: Prepare for Comps
