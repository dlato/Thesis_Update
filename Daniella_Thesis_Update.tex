...
\section*{Last Week}
\ch sent you a draft of my poster for SMBE
...
As I mentioned before, the GUI for Dotter is really bad and it constantly freezes. So I am still working through how to save plots where the contrast is good enough to define the inversions. This is really frustrating and long but oh well!

As I am re-running the selection and substitutions stuff I am finding more and more issues (most of them small things, which causes my previous code to not work so I have to tweak file formats) which is very very frustrating but I am slowly working through it.
...
I also need to work on your comments on my poster for the conference.

\section*{Next Week}

Continue working on poster for conference + print it!

Make edits to the papers.

Move on to next steps for the inversions and gene expression analysis
