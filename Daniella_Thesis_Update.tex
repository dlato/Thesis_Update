...
\ch  write \dn/\ds methods

\ch write \dn/\ds results

\ch write  \dn/\ds discussion

\ch write  \dn/\ds conclusion

\ch apply to Biology Travel Scholarship

\ch create graphs for expression distribution (no sub data)

\ch add \# of genes to expression graphs (top)
...
\textbf{\dn, \ds, $\omega$ Genomic Position Distribution:}

I made some new figures to show the distribution of \dn, \ds, $\omega$ across the genome. What are your thoughts on this? Do you think they are useful?
...
I need to fix one weird thing that seems to be happening with the distribution of \dn \ds and $\omega$ across the genome graphs. This should not take me too long to fix.

Write discussion and conclusion for gene expression paper. 
