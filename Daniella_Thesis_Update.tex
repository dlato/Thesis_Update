...
\begin{table}[h]
	...
	\caption{\label{tab:bigslope} Values of regression slope for each replicon using two points: 1) Highest weighted value of the number of substitutions / 10Kbp at position zero and 2) weighted value of the number of substitutions / 10Kbp of zero at the terminus. Simple linear regression was calculated. All results are marked with significance codes as followed: $<$ 0.001 = `***', 0.001 $<$ 0.01 = `**', 0.01 $<$ 0.05 = `*', $>$ 0.05 = `NS'.}
\end{table}
...
\begin{table}[h]
	...
	\resizebox{0.5\textwidth}{!}{%
		\begin{tabular}{lc}
			...
			\midrule
			\ecol Chromosome & \cc -2.19\e{-8}*** \\
			\bass Chromosome & \cc -6.02\e{-8}***\\
			\strep Chromosome & 5.34\e{-8}*** \\
			\smel Chromosome & \cc -3.80\e{-7}***  \\
			\smel pSymA & \cc -3.15\e{-7}*** \\
			\smel pSymB & 1.67\e{-7}***\\
			\bottomrule
		\end{tabular}
...
I have been working on the blast portion of this project and running blast with multiple parameters to see what we get.
