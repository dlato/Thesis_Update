...
\ch finished re-running subst and selection analysis (with new RAxML trees)
...
Queenie is still finishing things up but she is moving at a glacial pace.
Which for now is fine because I am busy with the subst paper, but soon I will have to take over from her to get everything done.
I had some issues with the gene mapping code but I fixed this.
It was an issue where one gene is so large that it matches to multiple smaller genes in another taxa.
For now I consider both of these a match and consider it a match to the blast results if blast also aligned either of those smaller genes.
\textbf{What do you think about this?}
...
I finished re-running the selection and subst analysis with the new RAxML trees.
Everything is essentially the same, except for \bass where the logistic regression changed sign.
I think this is because of the outliers.
I want to send you the paper and results once all the revisions are done, \textbf{but if you want it earlier, let me know!}

The outliers that were determined for the \bass subst analysis seem a bit off.
...
\section*{This Week (aka next week)}
...
\item start blast to confirm homologs in subst analysis?
\item distinction between mutations and substitutions in subst paper intro
\item update new code on git (subst paper)
\end{itemize}


\section*{Next Week (aka 2 weeks)}
\begin{itemize}
	\item finish blast to confirm homologs in subst analysis
	\item final edits of subst paper
	\item send subst paper to Brian to review
	\item make $\uparrow$ changes to subst paper
...
%	\bottomrule
%\end{tabular}
%\caption{\label{tab:datasets} Previous studies looking at substitutions/mutation rate.}
%%	}%resizebox
%\end{table}


%\begin{figure}
%	\includegraphics[width=\textwidth]{C:/Users/synch/Documents/PhD/Substitutions_paper/mauve_time_plot_extended_45.pdf}
%	\caption{\label{mauve_45}}	
%\end{figure}

\begin{figure}[h]
	\begin{center}
		\includegraphics[width=\textwidth]{C:/Users/synch/Documents/PhD/Substitutions_paper/GBE_paper_format/figs/bass_weighted_subs_bidirectionality_colour_22Sep20.pdf}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=\textwidth]{C:/Users/synch/Documents/PhD/Substitutions_paper/GBE_paper_format/figs/strep_dN_dS_omega_dist_14Sep20.pdf}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=\textwidth]{C:/Users/synch/Documents/PhD/Substitutions_paper/GBE_paper_format/figs/sinoC_dN_dS_omega_dist_21Sep20.pdf}
		\caption{\label{fig:sinoC_selection}}
	\end{center}
\end{figure}
...
\begin{table}[h]
	...
	\begin{tabular}{lcc}
		\toprule
		Bacteria and Replicon & \multicolumn{2}{c}{Protein Coding Sequences}\\
		\cmidrule{2-3}
		& Coefficient Estimate & $R^2$\\
		\midrule
		\ecol Chromosome & \cc -2.66\e{-8}*** &\\
		\bass Chromosome & 2.76\e{-8}***&\\
		\strep Chromosome & 7.21\e{-8}*** &\\
		\smel Chromosome & \cc -6.57\e{-7}*** & \\
		\smel pSymA & 2.74\e{-7}*** &\\
		\smel pSymB & 1.10\e{-7}*** &\\
		\bottomrule
	\end{tabular}
