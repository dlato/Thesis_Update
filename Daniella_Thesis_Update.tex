...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lcc}
			...
			\midrule
			\ecol Chromosome & 87.22\% & 12.78\% \\ % 4048616/4641652 & 
			\bass Chromosome &  & \\
			\strep Chromosome & & \\
			\smel Chromosome & & \\
			\smel pSymA & 83.34\% & 16.66\% \\ % 1128615/1354226 & 225611/1354226
			\smel pSymB & & \\
			\bottomrule
		\end{tabular}
		
	}%resizebox
	\caption{\label{tab:cod_non_cod_proportions} Total proportion of coding and non-coding sites in each replicon.}
\end{table}
